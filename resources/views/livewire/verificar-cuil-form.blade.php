...
<script>
    ...
    form.addEventListener('submit', function(event) {
        ...
        btnComprobar.innerHTML = '<div class="mx-auto border-gray-300 h-8 w-8 animate-spin rounded-full border-4 border-t-black"></div>';
        ...
        fetch(form.action, {
            ...
            .then(data => {
                ...
                btnComprobar.classList.remove('cursor-not-allowed', 'pointer-events-none','opacity-50')
