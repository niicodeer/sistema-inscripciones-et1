...
@section('content')
    <div class="px-2 w-[80%] mx-auto max-w-[500px]">
        <div>
            ...
            <p class="text-base text-center md:text-left text-[#202020]">Ingrese su número de CUIL para comprobar si se
                encuentra
...
@section('scripts')
    <script src="{{ asset('js/verificar-cuil-scripts.js') }}"></script>
@endsection
